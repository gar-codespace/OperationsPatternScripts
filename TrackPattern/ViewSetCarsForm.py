...
# Create the footer
    ...
    footerButtonSet[0].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(body, textBoxEntry).printButton
    footerButtonSet[1].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(body, textBoxEntry).setButton
#     footerButtonSet[2].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(formBody, textBoxEntry).trainPlayerButton
# # Put it all together
...
# # Create the footer
#     combinedFooter, footerButtonSet = TrackPattern.ViewSetCarsForm.setCarsFormFooter()
#     footerButtonSet[0].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(trackPattern, textBoxEntry).printButton
#     footerButtonSet[1].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(trackPattern, textBoxEntry).setButton
#     footerButtonSet[2].actionPerformed = TrackPattern.ControllerSetCarsForm.AnyButtonPressedListener(trackPattern, textBoxEntry).trainPlayerButton
# # Put it all together
#     setCarsForm.add(formHeader)
#     setCarsForm.add(javax.swing.JSeparator())
#     setCarsForm.add(buttonPanel)
